# X28c-TPU: champion (lambda_cos=1.0) with empirical-normal-quantile FEATURE preprocessing
# (ZWQ1037 EXP-TABM-011, CC BY 4.0: +0.001 both forward windows, better worst-month/Q25) on
# the torch_xla TPU port. Screen: seed 2026 fold5 vs replication target 0.170090, gate +0.004.
