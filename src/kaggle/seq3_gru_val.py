# GRU over 120x12 per-second-grid sequences (market+tx+order streams, engineered channels). GPU kernel. Val protocol: tr<=60 -> va 61-70 (+late 66-70).
...
TAG = os.environ.get('TAG', 'seq3')
SEQDATA = os.environ.get('SEQDATA', '/kaggle/input/datasets/diegoaranguren/mscapital-seq3-train')
...
NS_TR, NS_TE, STEPS, CH = 1257637, 647896, 120, 12
X_all = np.memmap(f'{SEQDATA}/seq3_train.f16', dtype=np.float16, mode='r', shape=(NS_TR, STEPS, CH))
