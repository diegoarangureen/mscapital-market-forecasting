# TPU REPLICATION RUN: seed 2026 fold5 only. Fidelity check of the torch_xla port vs GPU
# champion fold5 0.170090 (same recipe; per-epoch LR/noise anneal is the only intentional
# difference). If |delta| <= 0.002 -> port validated, then full kfold 5-seed follows.
...
TAG = os.environ.get('TAG', 'tpu455repl')
