# ABLATION: cos-dominant loss (lambda_cos 0.01 -> 1.0), 276f champion matrix. Direct-cos optimization is a confirmed top-team lever.
...
if os.environ.get('USE_XTRA', '1') == '1':
    ...
    print('XTRA attached ->', X_all.shape, flush=True)
...
TAG = os.environ.get('TAG', 'cosx21shift')
