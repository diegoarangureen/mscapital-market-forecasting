# RealMLP champion recipe 455f hyperparameter random search. tr<=60/val 61-70, cos loss.
# Env: SEED N_ENS EPOCHS LR BS TAG. Champion reference: N_ENS16 EP9 LR1e-3 BS256 -> val 0.1671.
...
print('455f champion base (no X26) ->', X_all.shape, flush=True)
