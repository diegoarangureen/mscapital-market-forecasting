...
y_raw = lab.target.values.astype(np.float64); month = lab.month.values
import pandas as pd
...
run('xallrank', ('X2','X7','X8','X9','X12','X13','X16'), tr60, va61, '246f rawY 0.132116')
run('xallrankshift', ('X2','X7','X8','X9','X12','X13','X16'), tr50, va51, '246f rawY shift 0.128442')
print('XRANK_DONE', flush=True)
