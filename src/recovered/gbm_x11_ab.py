...
run('x2x11', ('X2','X11'), tr60, va61, 'X2 0.123587')
run('x789x11', ('X2','X7','X8','X9','X11'), tr60, va61, 'X789 0.125xxx; blend check below')
run('x2x11shift', ('X2','X11'), tr50, va51, 'X2 0.122894')
print('X11AB_DONE', flush=True)
