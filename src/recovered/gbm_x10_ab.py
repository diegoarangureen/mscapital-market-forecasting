...
run('x2x10', ('X2','X10'), tr60, va61, 'X2+X7 0.124663')
run('x10shift', ('X2','X7','X8','X9','X10'), tr50, va51, 'X789 0.12496, X2+X7 0.125788, X2 0.122894')
run('x2x10shift', ('X2','X10'), tr50, va51, 'X2+X7 0.125788')
print('X10AB_DONE', flush=True)
