...
run('xallcos', ('X2','X7','X8','X9','X12','X13','X16'), tr60, va61, '246f L2-ES 0.132116')
run('xallcosshift', ('X2','X7','X8','X9','X12','X13','X16'), tr50, va51, '246f L2-ES shift 0.128442')
print('XCOS_DONE', flush=True)
