...
run('x2x12', ('X2','X12'), tr60, va61, 'X2 0.123587')
run('x789x12', ('X2','X7','X8','X9','X12'), tr60, va61, 'X789 0.126590')
run('x2x12shift', ('X2','X12'), tr50, va51, 'X2 0.122894')
print('X12AB_DONE', flush=True)
