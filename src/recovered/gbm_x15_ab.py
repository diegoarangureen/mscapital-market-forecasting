...
run('x2x15', ('X2','X15'), tr60, va61, 'X2 0.123587')
run('xall15', ('X2','X7','X8','X9','X12','X13','X15'), tr60, va61, 'X789X12X13 0.129131')
run('xall15shift', ('X2','X7','X8','X9','X12','X13','X15'), tr50, va51, 'X789X12X13 shift 0.128812')
print('X15AB_DONE', flush=True)
