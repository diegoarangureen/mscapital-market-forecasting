...
run('x7891213', ('X2','X7','X8','X9','X12','X13'), tr60, va61, 'X789X12 0.128181')
run('x7891213shift', ('X2','X7','X8','X9','X12','X13'), tr50, va51, 'X789X12 shift 0.127664')
pass
print('X13B_DONE', flush=True)
