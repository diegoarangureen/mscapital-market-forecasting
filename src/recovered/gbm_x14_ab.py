...
run('x2x14', ('X2','X14'), tr60, va61, 'X2 0.123587')
run('xall14', ('X2','X7','X8','X9','X12','X13','X14'), tr60, va61, 'X789X12X13 0.129131')
run('xall14shift', ('X2','X7','X8','X9','X12','X13','X14'), tr50, va51, 'X789X12X13 shift 0.128812')
print('X14AB_DONE', flush=True)
