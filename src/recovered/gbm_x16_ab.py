...
run('x2x16', ('X2','X16'), tr60, va61, 'X2 0.123587')
run('xall16', ('X2','X7','X8','X9','X12','X13','X16'), tr60, va61, 'X789X12X13 0.129131')
run('xall16shift', ('X2','X7','X8','X9','X12','X13','X16'), tr50, va51, 'X789X12X13 shift 0.128812')
print('X16AB_DONE', flush=True)
