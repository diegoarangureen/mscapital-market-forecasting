...
run('x2x18', ('X2','X18'), tr60, va61, 'X2 0.123587')
run('xall18', ('X2','X7','X8','X9','X12','X13','X16','X18'), tr60, va61, 'xall16 0.132116')
run('xall18shift', ('X2','X7','X8','X9','X12','X13','X16','X18'), tr50, va51, 'xall16 shift 0.128442')
print('X18AB_DONE', flush=True)
