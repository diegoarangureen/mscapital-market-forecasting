...
tr55 = month<=55; va56 = (month>=56)&(month<=65)
run('x2x16shift', ('X2','X16'), tr50, va51, 'X2 0.122894')
pass
pass
run('xall13mid', ('X2','X7','X8','X9','X12','X13'), tr55, va56, '214f midwindow ref')
run('xall16mid', ('X2','X7','X8','X9','X12','X13','X16'), tr55, va56, '246f midwindow')
print('X16B_DONE', flush=True)
