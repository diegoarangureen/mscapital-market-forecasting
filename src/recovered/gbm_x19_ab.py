...
run('x2x19', ('X2','X19'), tr60, va61, 'X2 0.123587')
run('xall19', ('X2','X7','X8','X9','X12','X13','X16','X19'), tr60, va61, '246f 0.132116')
run('xall19shift', ('X2','X7','X8','X9','X12','X13','X16','X19'), tr50, va51, '246f shift 0.128442')
print('X19AB_DONE', flush=True)
