...
run('x2x13', ('X2','X13'), tr60, va61, 'X2 0.123587')
run('x21213', ('X2','X12','X13'), tr60, va61, 'X2+X12 0.127005')
run('x21213shift', ('X2','X12','X13'), tr50, va51, 'X2+X12 shift 0.124715')
print('X13AB_DONE', flush=True)
