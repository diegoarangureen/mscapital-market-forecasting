...
VERSION = 25
OUT = ROOT / "data/interim/kaggle_results/transformer020_raw_full_v25"
...
def main() -> None:
    ...
    while time.monotonic() < deadline:
        ...
        if "KernelWorkerStatus.ERROR" in status or "KernelWorkerStatus.CANCEL" in status:
            ...
            raise RuntimeError("Transformer020 raw full v25 failed")
    ...
    print(command([
        ...
        "--file-pattern", r"score_only\.json$|result\.json$|standalone_factorized_transformer379_raw_full_e5\.csv$",
