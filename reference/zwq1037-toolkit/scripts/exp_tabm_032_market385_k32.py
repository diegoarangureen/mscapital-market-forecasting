"""Single-variable TabM385 validation for k=32 versus k=16."""
...
EXPERIMENT_ID = "EXP-TABM-032-MARKET385-K32"
...
def main() -> None:
    ...
    for fold_name, (train_end, valid_start, valid_end, score_key) in FOLDS.items():
        ...
        baseline_dir = (
            ...
            / "interim"
            / "tree_experiments"
            / "EXP-TABM-031-MARKET-TRAJECTORY6"
            / fold_name
        )
        baseline = json.loads(
    ...
    summary = {
        ...
        "baseline": "TabM385 k16, seed42, 15 epochs",
        "candidate": "TabM385 with only k changed from 16 to 32",
        "baseline_feature_count": 385,
        "candidate_feature_count": 385,
        "single_variable_change": "k=16 to k=32",
        "added_features": [],
        "folds": all_results,
