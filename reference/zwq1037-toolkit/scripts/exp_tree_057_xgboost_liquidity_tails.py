"""Test three exact within-sample liquidity tail features against EXP053R."""
...
from build_liquidity_tail_shape_features import FEATURE_COLUMNS as TAIL_FEATURE_COLUMNS
...
def main() -> None:
    ...
    tails = pd.read_feather(processed_dir / "train_liquidity_tail_shape_features.feather")
    ...
    print("training EXP-TREE-057 liquidity-tail candidate", flush=True)
    run_one(
        project_dir=project_dir,
        experiment_id="EXP-TREE-057",
        description=(
            "EXP053R plus exact within-sample full-sequence spread-tail ratio, "
