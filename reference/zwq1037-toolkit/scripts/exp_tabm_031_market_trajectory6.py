"""Paired TabM validation for six market-price trajectory features."""
...
EXPERIMENT_ID = "EXP-TABM-031-MARKET-TRAJECTORY6"
...
def main() -> None:
    ...
    summary = {
        ...
        "candidate": "baseline + 6 short-horizon market-price trajectory features",
