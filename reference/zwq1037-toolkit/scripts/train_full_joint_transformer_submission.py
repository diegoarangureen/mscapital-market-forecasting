"""Train the validated Joint-Transformer on all months and prepare its standalone submission."""
...
import exp_transformer_001_joint_dev as transformer
...
RUN_NAME = "joint_transformer_fulltrain"
SEED = 42
EPOCHS = 6
