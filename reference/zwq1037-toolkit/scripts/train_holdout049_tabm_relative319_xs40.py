"""Fit the validated Relative319+XS40 TabM recipe on months 0-49."""
...
RUN_NAME = "tabm_relative319_xs40_seed42_holdout049"
...
def main() -> None:
    ...
    train_indices = np.flatnonzero(train_months <= 49).astype(np.int64)
    ...
    torch.save(model.state_dict(), RUN_DIR / "model_holdout049.pt")
