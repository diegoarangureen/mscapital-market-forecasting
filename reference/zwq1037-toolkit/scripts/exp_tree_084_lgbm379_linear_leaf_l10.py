...
EXPERIMENT_ID="EXP-TREE-084-LGBM379-LINEAR-LEAF-L10"
...
def main():
    ...
    params={
      ...
      "lambda_l2":10.0,"linear_lambda":10.0,"lambda_l1":0.0,
    ...
    (out/"model.txt").write_text(model.model_to_string(num_iteration=int(best_iteration)),encoding="utf-8")
