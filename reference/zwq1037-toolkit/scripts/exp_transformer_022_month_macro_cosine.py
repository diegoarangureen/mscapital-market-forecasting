...
def main():
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        torch.save({
            ...
            "history": history, "sampler_epoch": epoch,
        }, FOLD / "recovery_checkpoint.pt")

    raw_best = best["raw"]
    ema_best = best["ema"]
    baseline_summary = json.loads((ROOT / "data/interim/tree_experiments/EXP-TRANSFORMER-020-FACTORIZED-EMA/score_summary.json").read_text(encoding="utf-8"))
