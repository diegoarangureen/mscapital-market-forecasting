"""Confirm cosine-weight 0.80 Joint-Transformer on months 60-70."""

import exp_transformer_011_cosine80_dev as experiment


def main() -> None:
    experiment.EXPERIMENT_ID = "EXP-TRANSFORMER-013-COSINE80-CONFIRM"
