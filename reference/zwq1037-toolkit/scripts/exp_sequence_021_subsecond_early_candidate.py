...
RUN = ROOT / 'data/interim/tree_experiments/EXP-SEQUENCE-021-SUBSECOND-EARLY-CANDIDATE'
SEED = 2026
BATCH_SIZE = 256
EPOCHS = 4
...
def main():
    ...
    config = {'seed': SEED, 'epochs': EPOCHS, 'batch_size': BATCH_SIZE,
              'smoke_batches': SMOKE_BATCHES, 'training_precision': 'float32', 'train_end': 47, 'purged_months': [48, 49], 'valid_start': 50, 'valid_end': 59,
              'excluded_month': None, 'paired_fixed_new_weight': 0.25, 'cache': str(CACHE)}
    recovery = None
    ...
    compact = {'experiment': 'EXP-SEQUENCE-020-SUBSECOND-GRU-TRANSFORMER',
               'best_cosine': best, 'baseline': None, 'delta': None,
    ...
    for epoch in range(start_epoch, EPOCHS + 1):
        ...
        compact = {'experiment': 'EXP-SEQUENCE-020-SUBSECOND-GRU-TRANSFORMER',
                   ...
                   'passed': bool(not SMOKE_BATCHES and False),
