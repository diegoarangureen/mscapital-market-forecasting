"""Evaluate 1,000-tree LightGBM on the complete EXP053R feature schema."""
...
def main() -> None:
    ...
    if len(feature_columns) != 307:
        raise AssertionError("Unexpected EXP068 feature count.")
    if len(feature_columns) != len(set(feature_columns)):
        raise AssertionError("Duplicate features entered EXP068.")
    ...
    print("training EXP-TREE-068 LightGBM 1000 trees on 307 features", flush=True)
    ...
    metadata = evaluate_and_save(
        ...
        experiment_id="EXP-TREE-068",
        description=(
            "LightGBM fixed-1000 comparison on the complete 307-feature EXP053R "
