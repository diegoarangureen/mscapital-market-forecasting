"""Upgrade the three owned slots in the current 0.150 blend with temporal ensembles."""
...
RUN_NAME = "current150_temporal_model_upgrades_realmlp57"
WEIGHTS = {"current": 0.15, "transformer": 0.16, "realmlp": 0.05}
...
def main() -> None:
    ...
    correlations = {}
    for slot in ("current", "transformer", "realmlp"):
    ...
    # Preserve the current equal-38 common-component convention.
    ...
    report = {
        ...
        "submission_policy": "second and final daily submission after standalone temporal calibration",
    }
