"""Train the validated cosine-0.80 Joint-Transformer on all months."""
...
import exp_transformer_011_cosine80_dev as transformer
...
RUN_NAME = "joint_transformer_cosine80_epoch5_fulltrain"
SEED = 42
EPOCHS = 5
...
def main() -> None:
    ...
    metadata = {
        ...
        "model": "standalone Joint-Transformer",
        "loss": "0.20 SmoothL1 + 0.80 centered cosine",
