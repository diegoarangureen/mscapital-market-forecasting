"""Test order-event timing dispersion features on EXP-TREE-034."""
...
from build_order_event_gap_features import FEATURE_COLUMNS
...
def main() -> None:
    ...
    if len(baseline_features) != 155 or len(feature_columns) != 159:
        raise AssertionError("Unexpected EXP-TREE-038 feature schema.")
    ...
    evaluate_and_save(
        ...
        experiment_id="EXP-TREE-038",
        description="add order event-gap mean, std, max, and nonzero share to EXP034",
        model=model,
