"""Fit Relative319+XS40+Order20+MarketTrajectory6 TabM on all 0-70 months."""
...
RUN_NAME = "tabm_relative319_xs40_order20_market6_deepwide_seed42_fulltrain"
...
def main() -> None:
    ...
    def make_model_deepwide(input_dimension: int, model_device: torch.device):
    ...
    model = make_model_deepwide(preprocessor.output_dimension, device)
    ...
    metadata = {
        ...
        "validation_62_70_no66": 0.15966356445919355,
        "validation_delta_vs_k32": -0.0013648346719459248,
        "tabm_k": 32,
        "n_blocks": 3,
        "d_block": 512,
        "dropout": 0.15,
