"""Train the validated hybrid-loss Joint-Transformer on all months."""
...
import exp_transformer_006_hybrid_loss_dev as transformer
...
RUN_NAME = "joint_transformer_hybrid_seed137_epoch4_fulltrain"
SEED = 137
EPOCHS = 4
