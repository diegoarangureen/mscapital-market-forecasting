"""Add four transaction-order cross features to the validated EXP-TREE-034 stack."""
...
def main() -> None:
    ...
    if len(feature_columns) != 159 or set(feature_columns).intersection(ORDER_FEATURE_COLUMNS):
        raise AssertionError("Expected the exact 159-feature combined schema.")
    ...
    evaluate_and_save(
        ...
        experiment_id="EXP-TREE-035",
        description="add four transaction-order pressure crosses to EXP034",
        model=model,
