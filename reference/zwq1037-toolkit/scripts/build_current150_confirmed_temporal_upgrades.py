"""Replace the owned TabM and Transformer slots in the current 0.150 blend."""
...
RUN_NAME = "current150_confirmed_tabm_transformer_temporal_upgrades"
WEIGHTS = {"current": 0.15, "transformer": 0.16}
...
def main() -> None:
    ...
    report = {
        ...
        "submission_policy": "fallback for second daily submission if RealMLP is unconvincing",
    }
